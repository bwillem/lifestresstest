...
function ACEs({ patientName, userTotal, populationAverage, ACEs }: ACEsProps) {
    ...
    return (
        <>
            ...
            <div className='flex items-center relative pb-8 after:[background:white] after:[height:10px] after:[width:1px] after:[right:-1px] after:[top:0] after:absolute after:content-" " before:[background:white] before:[height:10px] before:[width:1px] before:[left:-1px] before:[top:0] before:absolute before:content-" " border-b border-l border-r'>
                {hasACEs ? (
                    <>
                        <div className='w-2/3'>
